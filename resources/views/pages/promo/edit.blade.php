...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{route('promo.update', $promo->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                  <input type="text" value="{{old('judul', $promo->judul)}}" required class="form-control" name="judul" placeholder="judul" aria-label="First name">
                </div>
            ...
            <div class="row mt-4">
                <div class="col">
                  <input type="text" value="{{old('link', $promo->link)}}" required class="form-control" name="link" placeholder="link" aria-label="First name">
                </div>
