...
<div class="card">
    <div class="card-body">
        <h5 class="card-title">Edit Splash Screen</h5>
        <p class="card-description">Splash Screen yang telah ditampilkan akan muncul di halaman Splash Screen</p>
        <form action="/splash-screen/{{ $sp->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col">
                    <label class="form-label" for="">Judul</label>
                  <input type="text" required class="form-control" name="judul"  aria-label="First name" value="{{ $sp->judul }}">
                </div>
                <div class="col">
            ...
            <div class="row mt-1">
                <div class="col">
                    ...
                    <textarea class="form-control" id="post" rows="12"  name="desc" aria-label="With textarea">{!! $sp->desc !!}</textarea>
