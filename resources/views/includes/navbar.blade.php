    ...
    <div class="" id="navbarNav">
      ...
      <div class="" id="headerNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{asset('assets/images/avatars/profile-image.png')}}" alt="">{{ Auth::user()->name }} </a>
